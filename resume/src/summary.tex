...
\begin{itemize}
      ...
      \item Proficient in Microservices Architecture and skilled at leveraging technologies like \textbf{.Net Core, Angular, AWS, Azure, and MSSQL} to boost application performance and user experience.
